 ...
 * @Version 1.0
 */
public class DateUtils extends PropertyEditorSupport implements CommonConstant {
    ...
    public static long getDistanceSecond(String s1,String s2){
        Date d1=parse(s1);
        Date d2=parse(s2);
        return getDistanceSecond(d1,d2);
    }
    ...
    public static Date parse(String s){
        if(org.apache.commons.lang.StringUtils.isNotBlank(s)){ // 时间格式为 yyyy-MM-dd
    ...
    public static int daysBetween(String smdate,String bdate) {
        ...
        try {
            ...
            between_days=(time2-time1)/(DAY_IN_MILLIS);
        } catch (ParseException e) {
            e.printStackTrace();
        }
    ...
    /**
     * 获取时间,-1.昨天时间 0.当前时间 1.明天时间 *以此类推
     *
     * @param add int
     * @return map
     */
    public static Map<String, Object> getDateTime (int add) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        Calendar c = Calendar.getInstance();
        c.add(Calendar.DATE, add);
        String time = sdf.format(c.getTime());
        String bTime = time + TIME_BEGIN_SUFFIX;
        String eTime = time + TIME_END_SUFFIX;
        Map<String, Object> resultMap = new HashMap<>();
        resultMap.put(BEGIN_TIME, bTime);
        resultMap.put(END_TIME, eTime);
        return resultMap;
    }
