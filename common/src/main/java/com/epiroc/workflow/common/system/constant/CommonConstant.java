...
public interface CommonConstant {
    ...
    String ORDER_STATUS_TO_BE_SUBMIT = "-1";

    String ORDER_STATUS_RETURN_TO_BE_SUBMITTED = "5";

    String ORDER_STATUS_RETURN = "8";

    String ORDER_STATUS_CANCELLING = "6";

    String ORDER_STATUS_CANCEL = "3";

    String ORDER_STATUS_COMPLETE = "2";

    String ORDER_STATUS_PENDING = "1";

    String ORDER_STATUS_REJECT = "4";

    // 暂存
    String ORDER_STATUS_STORAGE = "0";

    String RETURN_TO_CREATOR = "0";

    String TASK_STATUS_COMPLETE = "2";

    String TASK_STATUS_WAITING = "1";

    String TASK_STATUS_UNAPPROVED = "0";
...
//    int  TOKEN_EXPIRE_TIME  = 3600;
    ...
    */
     ...
     */
    String CLOUD_SERVER_KEY = "eureka.client.service-url.defaultZone";
 ...
 String CACHE_REL_FIELD_OLD_VAL = "sys:cache:desform:relFieldOldVal:";
   ...
   public static final String SAAS_MODE_TENANT = "tenant";
    ...
    String UNIT_QUOTATION = "'";

    String UNIT_SPACE = " ";

    String UNIT_LESS_THAN = "<";

    String UNIT_MORE_THAN = ">";
    ...
    // 时间后缀
    String TIME_BEGIN_SUFFIX = " 00:00:00";

    String TIME_END_SUFFIX = " 23:59:59";
